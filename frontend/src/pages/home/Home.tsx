...
<div className="bg-white/80 backdrop-blur-xl rounded-xl border border-slate-200 focus-within:border-blue-500/60 focus-within:ring-2 focus-within:ring-blue-500/15 focus-within:shadow-[0_10px_30px_-12px_rgba(37,99,235,0.35)] transition-all shadow-sm overflow-hidden">
  <form
    onSubmit={handleQrBipado}
    className="p-2 flex flex-col sm:flex-row sm:items-center gap-2"
  >
    ...
    <button
      type="submit"
      className="w-full sm:w-auto shrink-0 bg-slate-50 hover:bg-slate-100 text-slate-700 px-6 h-11 sm:h-12 text-xs font-semibold rounded-lg border border-slate-200 hover:border-slate-300 transition-all tracking-wider uppercase"
    >
      Acessar
    </button>
  </form>
